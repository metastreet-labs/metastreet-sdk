...
const _getOSFees = async (params: GetFeesParams): Promise<GetFeesResult> => {
  const OS_V1_API_URL_MAINNET = "https://api.opensea.io/api/v1";
  const OS_V1_API_URL_GOERLI = "https://testnets-api.opensea.io/api/v1";
...
export const getOSFees = withReadableError(_getOSFees);
