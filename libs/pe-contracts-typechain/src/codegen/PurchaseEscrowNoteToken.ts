...
export interface PurchaseEscrowNoteTokenInterface extends utils.Interface {
  functions: {
...
export interface PurchaseEscrowNoteToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PurchaseEscrowNoteTokenInterface;
