...
export class TestERC20__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(name, symbol, decimals_, initialSupply, overrides || {}) as Promise<TestERC20>;
  }
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(name, symbol, decimals_, initialSupply, overrides || {});
  }
