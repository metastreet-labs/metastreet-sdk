...
export class MockVault__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(loanPriceOracle_, noteAdapter, overrides || {}) as Promise<MockVault>;
  }
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(loanPriceOracle_, noteAdapter, overrides || {});
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockVault {
