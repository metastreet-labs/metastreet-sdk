...
import type { MockLoanPriceOracle, MockLoanPriceOracleInterface } from "../MockLoanPriceOracle";
...
type MockLoanPriceOracleConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: MockLoanPriceOracleConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class MockLoanPriceOracle__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(currencyToken_, overrides || {}) as Promise<MockLoanPriceOracle>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MockLoanPriceOracle {
